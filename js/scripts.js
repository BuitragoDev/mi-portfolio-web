...
function cambiarIdioma() {
    ...
    if (languageToggle.innerText === 'ESP') {
        ...
        parrafo1.innerText = 'Hola! Me llamo Antonio Buitrago y soy una persona que se caracteriza por su entusiasmo y compromiso, siempre dispuesto a sumergirme en nuevos desafíos para adquirir experiencia y crecer profesionalmente. Me encanta lo que hago! Soy de los que se fijan en cada detalle y siempre busco dar lo mejor de mí. No me conformo con cualquier cosa, ¡quiero que todo salga perfecto!';
        parrafo2.innerText = 'Apasionado por el diseño y la programación de páginas web, no paro de aprender cosas nuevas para crear webs modernas. Me gusta mezclar la creatividad con la técnica, y uso herramientas como HTML, CSS, PHP o JavaScript, y frameworks como Bootstrap o React para crear interfaces que sean fáciles de usar y bonitas a la vista.';
        ...
        subtituloTrabajos.innerText = '¡Aquí puedes ver algunos ejemplos de mis trabajos! Encontrarás webs de todo tipo, y en todas ellas he puesto mi sello personal. Me gusta que sean bonitas, pero también que funcionen bien. ¡No te pierdas detalle!';
        webDesign.innerText = 'Web Diseñada';
        ...
        parrafo1.innerText = 'Hello! My name is Antonio Buitrago, and I am a person characterized by my enthusiasm and commitment, always willing to immerse myself in new challenges to gain experience and grow professionally. I love what I do! I am someone who pays attention to every detail and always seeks to give my best. I do not settle for anything less; I want everything to be perfect!';
        parrafo2.innerText = 'Passionate about web design and programming, I never stop learning new things to create modern websites. I enjoy blending creativity with technicality, utilizing tools such as HTML, CSS, PHP, or JavaScript, and frameworks like Bootstrap to craft interfaces that are both user-friendly and visually appealing.';
        parrafo3.innerText = 'Between 2014 and 2023, I had the fortune of living in Liverpool, an experience that taught me the importance of adaptability and working in diverse environments. This overseas experience has driven me to value global collaboration and actively seek opportunities to continue growing and learning in the professional field.';
        ...
        subtituloTrabajos.innerText = "Here you can see some examples of my work! You'll find websites of all kinds, and in all of them, I've put my personal touch. I like them to be beautiful, but also to function well. Don't miss any details!";
        webDesign.innerText = 'Web Designed';
