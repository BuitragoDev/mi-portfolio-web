<?php
    // Definir la clase para el objeto
    class Proyecto {
        public $titulo;
        public $imagen;
        public $tecnologias;
        ...
        // Constructor
        public function __construct($titulo, $imagen, $tecnologias, $enlace) {
            $this->titulo = $titulo;
            $this->imagen = $imagen;
    ...
    // Crear instancias de la clase Proyecto (Añadir una línea nueva por cada proyecto nuevo a mostrar en la sección de Trabajos)
    $proyectos = array(
        new Proyecto("Portfolio fotográfico", "img/proyecto1_img.webp", array("HTML5", "CSS", "Javascript"), "proyecto1/index.html"),
        new Proyecto("Tienda Online", "img/proyecto2_img.webp", array("Javascript", "PHP", "MySQL"), "proyecto2/index.php"),
        new Proyecto("Blog de Viajes", "img/proyecto3_img.webp", array("WordPress"), "wpblog/index.php"),
        new Proyecto("Web de Noticias", "img/proyecto4_img.webp", array("WordPress"), "wpnews/index.php"),
        new Proyecto("NCA Smart", "img/proyecto5_img.webp", array("WordPress", "SEO"), "https://www.ncasmart.com"),
        new Proyecto("Mi Biblioteca", "img/proyecto6_img.webp", array("Java", "App escritorio"), "https://github.com/BuitragoDev/Mi-Biblioteca-en-Java-Swing"),
        new Proyecto("Life Manager", "img/proyecto7_img.webp", array("C#", "App escritorio"), "https://github.com/BuitragoDev/LifeManager")
    );
?>
            ...
            <div class="container portada-container">
                <div class="row d-flex flex-column justify-content-evenly align-items-center">
                    <div class="col-lg-12">
                        ...
                        <p id="subtitulo" class="h5">Desarrollador<br>Front-end&nbsp;&nbsp;|&nbsp;&nbsp;Back-end</p>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <ul class="d-flex justify-content-center align-items-center gap-3 gap-lg-5 p-0 m-0">
                            ...
                            <li><a href="https://github.com/abuitragoES"><i class="fa-brands fa-github"></i></a></li>
            ...
            <div class="container about-container p-3 p-lg-5 mt-5">
                <div class="row">
                    <div class="col-lg-12 text-start">
                        ...
                        <p id="parrafo1" class="mt-5">Hola! Me llamo Antonio Buitrago y soy una persona que se caracteriza por su
                            ...
                            profesionalmente. Me encanta lo que hago! Soy de los que se fijan en cada detalle y siempre busco dar lo mejor de mí. No me conformo con cualquier cosa, ¡quiero que todo salga perfecto!</p>
                        <p id="parrafo2">Apasionado por el diseño y la programación de páginas web, no paro de aprender cosas nuevas para crear webs modernas. Me gusta mezclar la creatividad con la técnica, y uso herramientas como HTML, CSS, PHP o JavaScript, y frameworks como Bootstrap para crear interfaces que sean fáciles de usar y bonitas a la vista.</p>
                ...
                <div class="row">
                    <div class="col-lg-12 d-flex flex-wrap justify-content-center align-items-center mt-4 gap-4 gap-lg-5">
                        ...
                        <!-- Gráfico de Progreso de Bootstrap -->
                        <div class="progress-bar-container d-flex flex-column gap-3">
                            <div class="d-flex justify-content-center gap-3">
                        ...
                        <!-- Gráfico de Progreso de WordPress -->
                        <div class="progress-bar-container d-flex flex-column gap-3">
                            <div class="d-flex justify-content-center gap-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-start my-5">
                        <p><span id="subtitleCV">Aquí puedes ver mi Currículum Vitae, donde muestro mi experiencia laboral, los estudios
                            ...
                            PDF en</span> <a href="resume/CV_AntonioBuitragoGarcia_eng.pdf" target="_blank"
                                        ...
                                        <div class="timeline-wrap">
                                            ...
                                            <div class="timeline-block">
                                                ...
                                                <div class="timeline-header">
                                                    <h5>Diseñador Web</h5>
                                                    <p>Mayo 2024 - Junio 2024</p>
                                                </div>
                                                <div class="timeline-content">
                                                    <h5>NCA The Smart Agency (Madrid)</h5>
                                                    <p>Formé parte del equipo encargado de la optimización del SEO de la página web, implementando estrategias para mejorar el posicionamiento en motores de búsqueda. Realización de mejoras en la página web, optimización de la velocidad de carga e implementación de nuevas funcionalidades (usando WordPress) durante las prácticas del curso de Desarrollo de Aplicaciones con Tecnologías Web.</p>
                                                    <hr>
                                                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 my-5">
                        <p id="subtituloTrabajos">
¡Aquí puedes ver algunos ejemplos de mis trabajos! Encontrarás webs de todo tipo, y en todas ellas he puesto mi sello personal. Me gusta que sean bonitas, pero también que funcionen bien. ¡No te pierdas detalle!</p>
                    </div>
                </div> <!-- /.row -->
                        ...
                        <div class="col-md-4">
                            <div class="work-box">
                                <a href="#">
                                    <div class="work-img">
                                        <a href="<?= $proyecto->enlace ?>" target="_blank"
                                            title="Enlace a la web <?= $proyecto->titulo ?> de mi Portfolio"><img
                                                src="<?= $proyecto->imagen ?>"
                                                alt="Imagen de la portada de la web <?= $proyecto->titulo ?> de mi Portfolio"
                                                class="img-fluid"></a>
                                    </div>
                                </a>
                                <div class="work-content">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <h2 class="w-title"><?= $proyecto->titulo ?></h2>
                                            <div class="w-more">
                                                <span id="webDesign" class="w-ctegory"><?= implode(", ", $proyecto->tecnologias) ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="w-like">
                                                <a href="<?= $proyecto->enlace ?>" target="_blank"
                                                    title="Enlace a la web <?= $proyecto->titulo ?> de mi Portfolio"><i
        ...
        <div class="container footer-container">
            ...
            <div class="row d-flex justify-content-between align-items-center pt-3">
                <div class="col-12 col-lg-8 d-flex align-items-center footer-left m-0">
                    <p>&copy 2024 - <span id="copyFooter1">Diseñado por</span> <a href="index.php" target="_self" title="Ir la página de portada">Antonio Buitrago</a>. <span id="copyFooter2">Todos los derechos reservados.</span></p>    
                </div>
